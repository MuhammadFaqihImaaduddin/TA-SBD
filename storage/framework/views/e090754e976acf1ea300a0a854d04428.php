              ...
              <div class="card-body">
                <form method="POST" action="<?php echo e(route('login')); ?>" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <input id="email" type="email" tabindex="1" class="form-control <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="password" tabindex="2" class="form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
</html><?php /**PATH /var/www/html/ta-undip/resources/views/auth/login.blade.php ENDPATH**/ ?>